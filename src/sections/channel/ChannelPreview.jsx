...
export default function ChannelPreview({ channel, open, onClose, editChannel }) {
  ...
  return (
    <>
              ...
              >
                <ListItemAvatar sx={{ mr: 0.75 }}>
                  <Avatar
                    alt={channel.name}
                    size="lg"
                    src={getImageUrl(`avatar-${!channel.avatar ? 1 : channel.avatar}.png`, ImagePath.USERS)}
                  />
                </ListItemAvatar>
                <ListItemText
                  primary={<Typography variant="h5">{channel.name}</Typography>}
                  secondary={<Typography color="secondary">{channel.role}</Typography>}
                />
              </ListItem>
            </List>
          </DialogTitle>
                  ...
                  <Grid container spacing={2.25}>
                    <Grid item xs={12}>
                      <MainCard title="About me">
                        <Typography>
                          Channel Name: {channel.name}, {channel.assetType} Trade Type: {channel.tradeType}
                        </Typography>
                      </MainCard>
                    </Grid>
                    <Grid item xs={12}>
      ...
      <AlertCustomerDelete id={channel.id} title={channel.name} open={openAlert} handleClose={handleClose} />
    </>
  );
}
